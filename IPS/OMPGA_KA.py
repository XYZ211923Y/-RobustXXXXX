...
class Attacker(object):
    ...
    def eval_object(self, eval_funccall, greedy_set, orig_label, changed_set, greedy_set_visit_idx,
        ...
        if max_subsets_object >= 0:
            ...
            return max_subsets_object, greedy_set_best_temp_funccall, success_flag, changed_set, greedy_set, \
                   greedy_set_visit_idx, flip_set, flip_funccall
    ...
    def attack(self, funccall, y):
        ...
        while success_flag == 1:
            ...
            flip_set, flip_funccall = self.eval_object(funccall, greedy_set, y, changed_set,
                                              greedy_set_visit_idx, greedy_set_best_temp_funccall)
...
log_attack = open(
    '../Logs/malware/%s/gradmax_Attack.bak' % Model_Type, 'w+')
...
for i in range(len(X)):
    ...
    pickle.dump(mf_process_all,
                open('../Logs/malware/%s/gradmax_mf_process.pickle' % Model_Type, 'wb'))
    pickle.dump(greedy_set_process_all,
                open('../Logs/malware/%s/gradmax_greedy_set_process.pickle' % Model_Type, 'wb'))
    pickle.dump(changed_set_process_all,
                open('../Logs/malware/%s/gradmax_changed_set_process.pickle' % Model_Type, 'wb'))
    pickle.dump(iterations_all,
                open('../Logs/malware/%s/gradmax_iteration.pickle' % Model_Type, 'wb'))
    pickle.dump(robust_flag_all,
                open('../Logs/malware/%s/gradmax_robust_flag.pickle' % Model_Type, 'wb'))
    pickle.dump(orignal_funccalls_all,
                open('../Logs/malware/%s/gradmax_original_funccall.pickle' % Model_Type, 'wb'))
    pickle.dump(orignal_labels_all,
                open('../Logs/malware/%s/gradmax_original_label.pickle' % Model_Type, 'wb'))
    pickle.dump(orignal_g_all,
                open('../Logs/malware/%s/gradmax_original_g.pickle' % Model_Type, 'wb'))
    pickle.dump(final_greedy_set_all,
                open('../Logs/malware/%s/gradmax_greedy_set.pickle' % Model_Type, 'wb'))
    pickle.dump(final_greedy_set_visit_idx_all,
                open('../Logs/malware/%s/gradmax_feature_greedy_set.pickle' % Model_Type, 'wb'))
    pickle.dump(final_funccall_all,
                open('../Logs/malware/%s/gradmax_modified_funccall.pickle' % Model_Type, 'wb'))
    pickle.dump(final_g_all,
                open('../Logs/malware/%s/gradmax_final_probs.pickle' % Model_Type, 'wb'))
    pickle.dump(final_mf_all,
                open('../Logs/malware/%s/gradmax_final_mf.pickle' % Model_Type, 'wb'))
    pickle.dump(final_changed_set_all,
                open('../Logs/malware/%s/gradmax_changed_set.pickle' % Model_Type, 'wb'))
    pickle.dump(final_changed_num_all,
                open('../Logs/malware/%s/gradmax_changed_num.pickle' % Model_Type, 'wb'))
    pickle.dump(flip_funccall_all,
                open('../Logs/malware/%s/gradmax_flip_funccall.pickle' % Model_Type, 'wb'))
    pickle.dump(flip_set_all,
                open('../Logs/malware/%s/gradmax_flip_set.pickle' % Model_Type, 'wb'))
    pickle.dump(flip_mf_all,
                open('../Logs/malware/%s/gradmax_flip_mf.pickle' % Model_Type, 'wb'))
    pickle.dump(flip_sample_original_label_all,
                open('../Logs/malware/%s/gradmax_flip_sample_original_label.pickle' % Model_Type, 'wb'))
    pickle.dump(flip_sample_index_all,
                open('../Logs/malware/%s/gradmax_flip_sample_index.pickle' % Model_Type, 'wb'))
