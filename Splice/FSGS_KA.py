...
class Attacker(object):
    ...
    def attack(self, funccall, y):
        ...
        while success_flag == 1:
            ...
            if (time.time() - st) > 3600 or iteration == 15:
                success_flag = -1
                robust_flag = 1
...
log_attack = open(
    '../Logs/gene/%s/greedmax_Attack.bak' % Model_Type, 'w+')
...
for i in range(len(X)):
    ...
    pickle.dump(mf_process_all,
                open('../Logs/gene/%s/greedmax_mf_process.pickle' %Model_Type, 'wb'))
    pickle.dump(greedy_set_process_all,
                open('../Logs/gene/%s/greedmax_greedy_set_process.pickle' %Model_Type, 'wb'))
    pickle.dump(changed_set_process_all,
                open('../Logs/gene/%s/greedmax_changed_set_process.pickle' %Model_Type, 'wb'))
    pickle.dump(iterations_all,
                open('../Logs/gene/%s/greedmax_iteration.pickle' %Model_Type, 'wb'))
    pickle.dump(robust_flag_all,
                open('../Logs/gene/%s/greedmax_robust_flag.pickle' %Model_Type, 'wb'))
    pickle.dump(orignal_funccalls_all,
                open('../Logs/gene/%s/greedmax_original_funccall.pickle' %Model_Type, 'wb'))
    pickle.dump(orignal_labels_all,
                open('../Logs/gene/%s/greedmax_original_label.pickle' %Model_Type, 'wb'))
    pickle.dump(orignal_g_all,
                open('../Logs/gene/%s/greedmax_original_g.pickle' %Model_Type, 'wb'))
    pickle.dump(final_greedy_set_all,
                open('../Logs/gene/%s/greedmax_greedy_set.pickle' %Model_Type, 'wb'))
    pickle.dump(final_greedy_set_visit_idx_all,
                open('../Logs/gene/%s/greedmax_feature_greedy_set.pickle' %Model_Type, 'wb'))
    pickle.dump(final_funccall_all,
                open('../Logs/gene/%s/greedmax_modified_funccall.pickle' %Model_Type, 'wb'))
    pickle.dump(final_g_all,
                open('../Logs/gene/%s/greedmax_final_probs.pickle' %Model_Type, 'wb'))
    pickle.dump(final_mf_all,
                open('../Logs/gene/%s/greedmax_final_mf.pickle' %Model_Type, 'wb'))
    pickle.dump(final_changed_set_all,
                open('../Logs/gene/%s/greedmax_changed_set.pickle' %Model_Type, 'wb'))
    pickle.dump(final_changed_num_all,
                open('../Logs/gene/%s/greedmax_changed_num.pickle' %Model_Type, 'wb'))
    pickle.dump(flip_funccall_all,
                open('../Logs/gene/%s/greedmax_flip_funccall.pickle' %Model_Type, 'wb'))
    pickle.dump(flip_set_all,
                open('../Logs/gene/%s/greedmax_flip_set.pickle' %Model_Type, 'wb'))
    pickle.dump(flip_mf_all,
                open('../Logs/gene/%s/greedmax_flip_mf.pickle' %Model_Type, 'wb'))
    pickle.dump(flip_sample_original_label_all,
                open('../Logs/gene/%s/greedmax_flip_sample_original_label.pickle' %Model_Type, 'wb'))
    pickle.dump(flip_sample_index_all,
                open('../Logs/gene/%s/greedmax_flip_sample_index.pickle' %Model_Type, 'wb'))