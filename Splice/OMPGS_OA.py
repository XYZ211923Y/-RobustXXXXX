...
class Attacker(object):
    ...
    def eval_object(self, eval_funccall, greedy_set, orig_label, current_h1, current_h2, current_g, changed_set,
        ...
        while real_k > 0:
            ...
            chosen_function = sorted_feature[idx]
...
log_attack = open(
    '../Logs/gene/%s/gradmin_Attack.bak' % Model_Type, 'w+')
...
for i in range(len(X)):
    ...
    pickle.dump(mf_process_all,
                open('../Logs/gene/%s/gradmin_mf_process.pickle' % Model_Type, 'wb'))
    pickle.dump(greedy_set_process_all,
                open('../Logs/gene/%s/gradmin_greedy_set_process.pickle' % Model_Type, 'wb'))
    pickle.dump(changed_set_process_all,
                open('../Logs/gene/%s/gradmin_changed_set_process.pickle' % Model_Type, 'wb'))
    pickle.dump(iterations_all,
                open('../Logs/gene/%s/gradmin_iteration.pickle' % Model_Type, 'wb'))
    pickle.dump(robust_flag_all,
                open('../Logs/gene/%s/gradmin_robust_flag.pickle' % Model_Type, 'wb'))
    pickle.dump(orignal_funccalls_all,
                open('../Logs/gene/%s/gradmin_original_funccall.pickle' % Model_Type, 'wb'))
    pickle.dump(orignal_labels_all,
                open('../Logs/gene/%s/gradmin_original_label.pickle' % Model_Type, 'wb'))
    pickle.dump(orignal_g_all,
                open('../Logs/gene/%s/gradmin_original_g.pickle' % Model_Type, 'wb'))
    pickle.dump(final_greedy_set_all,
                open('../Logs/gene/%s/gradmin_greedy_set.pickle' % Model_Type, 'wb'))
    pickle.dump(final_greedy_set_visit_idx_all,
                open('../Logs/gene/%s/gradmin_feature_greedy_set.pickle' % Model_Type, 'wb'))
    pickle.dump(final_funccall_all,
                open('../Logs/gene/%s/gradmin_modified_funccall.pickle' % Model_Type, 'wb'))
    pickle.dump(final_g_all,
                open('../Logs/gene/%s/gradmin_final_probs.pickle' % Model_Type, 'wb'))
    pickle.dump(final_mf_all,
                open('../Logs/gene/%s/gradmin_final_mf.pickle' % Model_Type, 'wb'))
    pickle.dump(final_changed_set_all,
                open('../Logs/gene/%s/gradmin_changed_set.pickle' % Model_Type, 'wb'))
    pickle.dump(final_changed_num_all,
                open('../Logs/gene/%s/gradmin_changed_num.pickle' % Model_Type, 'wb'))
    pickle.dump(flip_funccall_all,
                open('../Logs/gene/%s/gradmin_flip_funccall.pickle' % Model_Type, 'wb'))
    pickle.dump(flip_set_all,
                open('../Logs/gene/%s/gradmin_flip_set.pickle' % Model_Type, 'wb'))
    pickle.dump(flip_mf_all,
                open('../Logs/gene/%s/gradmin_flip_mf.pickle' % Model_Type, 'wb'))
    pickle.dump(flip_sample_original_label_all,
                open('../Logs/gene/%s/gradmin_flip_sample_original_label.pickle' % Model_Type, 'wb'))
    pickle.dump(flip_sample_index_all,
                open('../Logs/gene/%s/gradmin_flip_sample_index.pickle' % Model_Type, 'wb'))
    pickle.dump(failue_set_all,
                open('../Logs/gene/%s/gradmin_failure_set.pickle' % Model_Type, 'wb'))
